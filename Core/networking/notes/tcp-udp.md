...
<div align="center"> <img src="image-20201014100900834.png" width="40%"/> </div><br>
...
`TCP` 利用滑动窗口进行流量控制，即根据自己接收缓存的大小，动态地调整发送方的发送窗口大小



看个例子：

<div align="center"> <img src="image-20201014111832434.png" width="90%"/> </div><br> 
